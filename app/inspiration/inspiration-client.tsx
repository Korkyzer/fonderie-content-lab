          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              <Button
                ...
                disabled
                title="L'import de veille réelle arrive au Sprint 3."
              >
                Import à connecter
              </Button>
              <Link href="/generator?title=Brief%20inspiration&platform=Instagram%20Reel&audience=Lyc%C3%A9ens%2016-20&body=Construire%20un%20brief%20%C3%A0%20partir%20de%20plusieurs%20r%C3%A9f%C3%A9rences%20visuelles%20et%20hooks%20social%20media.">
                <Button variant="primary" size="sm" icon={<Icon name="sparkle" size={12} />}>
        ...
        {filtered.map((item) => (
          <Panel key={item.id} className="space-y-4 bg-cream">
            ...
            <div className="flex items-center justify-between gap-3 border-t border-ink/8 pt-3">
              ...
              <Link href={item.generatorHref}>
                <Button variant="dark" size="sm" iconRight={<Icon name="arrow" size={12} />}>
                  S&apos;inspirer
                </Button>
              </Link>
            </div>
